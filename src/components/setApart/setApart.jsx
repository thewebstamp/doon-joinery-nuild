    ...
    return (
        <div className="set-apart-wrap">
            <div className="sa-top" ref={setApartT}>
                <div className="sa-headline">WHY CHOOSE DOON JOINERY & BUILDING LTD?</div>
                <h2>We are a Trusted Name in the Construction Industry</h2>
            ...
            <div className="sa-base" ref={setApartB}>
                ...
                <img src={Images.heroImg2} className="sa-img" />
                <img src={Images.heroImg2} className="sa-img-height" />
            </div>
        </div>
    )
}
