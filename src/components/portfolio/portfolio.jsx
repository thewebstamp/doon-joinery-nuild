...
function Portfolio() {
    ...
    const [portfolio, setPortfolio] = useState([
        ...
        Images.p11, Images.p12, Images.p13, Images.p14, Images.p15, Images.p16, Images.p17, Images.p18, Images.p19, Images.p20,
        Images.p21, Images.p22, Images.p23, Images.p24, Images.p25, Images.p26, Images.p27, Images.p28, Images.p29, Images.p30,
        Images.p31, Images.p32, Images.p33, Images.p34
    ]);
    ...
    return (
        <div className="portfolio-comp" id='portfolio' ref={portfolioA}>
            ...
            <h2>Latest Completed Projects of Doon Joinery & Building Ltd</h2>
